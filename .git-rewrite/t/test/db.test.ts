...
describe("Migration Helpers", () => {
  ...
  test("migration works on existing database without new columns", async () => {
    ...
    try {
      ...
      await inMemoryClient.execute(`CREATE TABLE IF NOT EXISTS requests (id TEXT PRIMARY KEY, human_id TEXT, delete_token_hash TEXT, text TEXT, budget_min_cents INTEGER, budget_max_cents INTEGER, currency TEXT, tags TEXT, status TEXT, hidden INTEGER, created_at INTEGER, updated_at INTEGER)`);
