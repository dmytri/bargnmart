...
header { max-width: 1100px; margin: 12px auto; padding: 10px 20px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px; border: 1px solid #444; border-radius: 12px; position: sticky; top: 12px; z-index: 100; background: #1a1a3a; }
